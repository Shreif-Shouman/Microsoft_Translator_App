...
custom_html = """
            <div style="text-align: center;">
                <div style="display: inline-block; overflow: hidden; height: auto; width: 50%; max-width: 300px; background-color: #f0f0f0; border-radius: 20px; border: 1px solid gray; margin-bottom: 20px;">
                    <img src="https://ehlion.com/wp-content/uploads/2021/10/microsoft-translator-review-by-ehlion.jpg" style="width: 100%; height: auto; object-fit: contain; border-radius: 20px;">
                </div>
